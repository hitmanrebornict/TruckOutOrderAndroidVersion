...
public class CapturePhoto extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnPost = findViewById(R.id.btnProceedToPost);
        ...
        btnPhoto.setOnClickListener(view -> capturePhoto());

        btnPost.setOnClickListener(view -> startActivity(new Intent(CapturePhoto.this,PostPage.class)));
    }
